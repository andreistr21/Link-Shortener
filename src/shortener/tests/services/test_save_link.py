...
class SaveLinkTests(TestCase):
    def _save_link_test_method(self, long_link, alias):
    ...
    def test_save_with_existing_long_link(self):
        long_link = "youtube.com"
        self._save_link_test_method(long_link, "test-short-link")
        self._save_link_test_method(long_link, "test-short-link-2")
    ...
    def test_save_with_existing_alias(self):
        long_link = "youtube.com"
        alias = "test-short-link"
        self._save_link_test_method(long_link, alias)
        
        self.assertRaises(IntegrityError, self._save_link_test_method, long_link=long_link, alias=alias)
